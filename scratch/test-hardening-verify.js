...
async function runTests() {
    ...
    console.log(`deletedAt value: ${softDeletedLead === null || softDeletedLead === void 0 ? void 0 : softDeletedLead.deletedAt}`);
    if (!(softDeletedLead === null || softDeletedLead === void 0 ? void 0 : softDeletedLead.deletedAt)) {
    ...
    console.log(`Restored deletedAt: ${restoredLead === null || restoredLead === void 0 ? void 0 : restoredLead.deletedAt} (Should be null/null)`);
    if ((restoredLead === null || restoredLead === void 0 ? void 0 : restoredLead.deletedAt) !== null) {
        throw new Error('Lead was not restored (deletedAt should be null)!');
    }
    console.log(`Restored tier: ${restoredLead === null || restoredLead === void 0 ? void 0 : restoredLead.tier} (Should be 1)`);
    console.log(`Restored score: ${restoredLead === null || restoredLead === void 0 ? void 0 : restoredLead.score} (Should be 95)`);
    console.log(`Restored sources: ${restoredLead === null || restoredLead === void 0 ? void 0 : restoredLead.source} (Should contain both)`);
    ...
    console.log(`Backdated lead createdAt: ${backdatedLead === null || backdatedLead === void 0 ? void 0 : backdatedLead.createdAt.toISOString()}`);
