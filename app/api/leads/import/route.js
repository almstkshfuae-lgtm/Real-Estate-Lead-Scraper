...
function resolveRow(raw) {
    ...
    for (const [key, value] of Object.entries(raw)) {
        ...
        const valStr = String(value !== null && value !== void 0 ? value : "").trim();
    ...
    for (const [key, value] of Object.entries(raw)) {
        ...
        if (canonical) {
            ...
            out[canonical] = String(value !== null && value !== void 0 ? value : "").trim();
        }
        else {
            out[key.trim()] = String(value !== null && value !== void 0 ? value : "").trim();
        }
    }
    return out;
}
...
export async function POST(request) {
    ...
    try {
        ...
        const isAdmin = ((_a = session.role) === null || _a === void 0 ? void 0 : _a.toUpperCase()) === 'ADMIN';
        ...
        try {
            ...
            for (const rawRow of rawLeads) {
                ...
                const hasIdentity = name !== "Unknown Contact" ||
                    email !== null ||
                    phone !== null ||
                ...
                if (existingByUnique) {
                    ...
                    const shouldUpdate = (email && !existingByUnique.email) ||
