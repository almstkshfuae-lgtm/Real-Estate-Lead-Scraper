...
export async function POST(req) {
    ...
    try {
        ...
        if (!aiConfig) {
            return NextResponse.json({ error: "Gemini API key not configured. Go to Settings → Integrations and add your Google AI API key." }, { status: 503 });
        }
...
الميزانية: ${lead.budgetMin ? `${lead.budgetMin.toLocaleString()} - ${(_a = lead.budgetMax) === null || _a === void 0 ? void 0 : _a.toLocaleString()} درهم` : "غير محددة"}
...
Budget: ${lead.budgetMin ? `AED ${lead.budgetMin.toLocaleString()} - ${(_b = lead.budgetMax) === null || _b === void 0 ? void 0 : _b.toLocaleString()}` : "Not specified"}
...
Write the pitch directly without any preamble:`;
        ...
        console.error("[AI Pitch Error]", (error === null || error === void 0 ? void 0 : error.message) || error);
        return NextResponse.json({ error: "Failed to generate pitch", detail: error === null || error === void 0 ? void 0 : error.message }, { status: 500 });
    }
}
