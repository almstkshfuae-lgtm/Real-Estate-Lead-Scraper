...
Respond ONLY with valid JSON: {"refinedScore": <number>, "delta": <number>, "reasoning": "<1-2 sentence justification>", "recommendations": ["<action 1>", "<action 2>"]}`;
        ...
        console.error("[AI Score Error]", (error === null || error === void 0 ? void 0 : error.message) || error);
        return NextResponse.json({ error: "Failed to refine score", detail: error === null || error === void 0 ? void 0 : error.message }, { status: 500 });
    }
}
